...
# NUM_LANDMARKS = 42         
# IMG_SIZE = 227             
# MODEL_PATH = "C:/Users/ronde/PROJECTS/ASL_TO_TEXT/models/improved_balanced_asl_model.h5"
# LABEL_ENCODER_PATH = "C:/Users/ronde/PROJECTS/ASL_TO_TEXT/data/labels/label_encoder.pkl"
# SPEECH_DELAY = 3           
...
#     """Plays an audio file asynchronously and schedules it for deletion after AUDIO_FILE_LIFETIME seconds."""
#     try:
...
#         # Schedule file deletion after seconds
...
#     """Preprocess landmarks to create an input image compatible with the existing model."""
...
#             # Visualize normalized hand landmarks
